...
#ifndef __SOLID_CPU_CORE_UNARY_OPS_H__
#define __SOLID_CPU_CORE_UNARY_OPS_H__

#include <math.h>


/* Single-precision functions and constants */
#define SOLID_FLOAT_CONST_LN2   ((float)(0.69314718055994529))
#define SOLID_FLOAT_CONST_LN10  ((float)(2.3025850929940459))
#define SOLID_FLOAT_CONST_INF   ((float)(1./0.))
...
#define SOLID_FLOAT_EXP10(X)    expf(SOLID_FLOAT_CONST_LN10 * (X))
...
#define SOLID_FLOAT_FMOD        fmod
#define SOLID_FLOAT_ISFINITE    isfinite
#define SOLID_FLOAT_ISINF       isinf
#define SOLID_FLOAT_ISNAN       isnan

#define SOLID_FLOAT_COPYSIGN    copysignf


/* Double-precision functions */
#define SOLID_DOUBLE_CONST_LN2  ((double)(0.69314718055994529))
#define SOLID_DOUBLE_CONST_LN10 ((double)(2.3025850929940459))
#define SOLID_DOUBLE_CONST_INF  ((double)(1./0.))
...
#define SOLID_DOUBLE_EXP10(X)   exp(SOLID_DOUBLE_CONST_LN10 * (X))
...
#define SOLID_DOUBLE_COPYSIGN   copysign
...
#define SOLID_HALF_CONST_INF    0xFC00
...
#define SOLID_HALF_EXP10(X)     SOLID_FLOAT_EXP10(X)
...
#define SOLID_HALF_COPYSIGN     SOLID_FLOAT_COPYSIGN
