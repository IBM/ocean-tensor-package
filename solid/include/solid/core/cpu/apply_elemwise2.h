...
#ifndef __SOLID_APPLY_ELEMWISE2_CPU_H__
#define __SOLID_APPLY_ELEMWISE2_CPU_H__
...
/* The variables exposed by the macros are: _ptr1, _ptr2     */


/* --------------------------------------------------------------------- */
/* Macro: SOLID_APPLY_ELEMWISE2                                          */
/* --------------------------------------------------------------------- */

#define SOLID_APPLY_ELEMWISE2(CODE) \
   SOLID_APPLY_ELEMWISE2_CTYPE(SOLID_C_TYPE(SDXTYPE), SOLID_C_TYPE(SDXTYPE), CODE, \
                               ndims, size, ptr1, strides1, ptr2, strides2, -1)

#define SOLID_APPLY_ELEMWISE2_TYPES(TYPE1, TYPE2, CODE) \
   SOLID_APPLY_ELEMWISE2_CTYPE(SOLID_C_TYPE(TYPE1), SOLID_C_TYPE(TYPE2), CODE, \
                               ndims, size, ptr1, strides1, ptr2, strides2, -1)

#if SOLID_ENABLE_OMP
#define SOLID_APPLY_ELEMWISE2_CTYPE(TYPE1, TYPE2, CODE, NDIMS, SIZE, PTR1, STRIDES1, PTR2, STRIDES2, NTHREADS) \
   {  int __solid_omp_threads = NTHREADS; \
      ...
      {   \
         ...
         SOLID_APPLY_ELEMWISE2_OMP_CTYPE(TYPE1, TYPE2, CODE, NDIMS, SIZE, PTR1, STRIDES1, PTR2, STRIDES2) \
      } \
      else \
      {  SOLID_APPLY_ELEMWISE2_CPU_CTYPE(TYPE1, TYPE2, CODE, NDIMS, SIZE, PTR1, STRIDES1, PTR2, STRIDES2) \
      } \
   }
#else
#define SOLID_APPLY_ELEMWISE2_CTYPE(TYPE1, TYPE2, CODE, NDIMS, SIZE, PTR1, STRIDES1, PTR2, STRIDES2, NTHREADS) \
...
/* --------------------------------------------------------------------- */
/* Macro: SOLID_APPLY_ELEMWISE2_CPU                                      */
/* --------------------------------------------------------------------- */

#define SOLID_APPLY_ELEMWISE2_CPU(CODE) \
   SOLID_APPLY_ELEMWISE2_CPU_CTYPE(SOLID_C_TYPE(SDXTYPE), SOLID_C_TYPE(SDXTYPE), CODE, \
                                   ndims, size, ptr1, strides1, ptr2, strides2)

#define SOLID_APPLY_ELEMWISE2_CPU_CTYPE(TYPE1, TYPE2, CODE, NDIMS, SIZE, PTR1, STRIDES1, PTR2, STRIDES2) \
   {  size_t    _idx[SOLID_MAX_TENSOR_DIMS] = {0}; \
...
/* --------------------------------------------------------------------- */
/* Macro: SOLID_APPLY_ELEMWISE2_OMP                                      */
/* --------------------------------------------------------------------- */

#define SOLID_APPLY_ELEMWISE2_OMP(CODE) \
   SOLID_APPLY_ELEMWISE2_OMP_CTYPE(SOLID_C_TYPE(SDXTYPE), SOLID_C_TYPE(SDXTYPE), CODE, \
                                   ndims, size, ptr1, strides1, ptr2, strides2)

#define SOLID_APPLY_ELEMWISE2_OMP_CTYPE(TYPE1, TYPE2, CODE, NDIMS, SIZE, PTR1, STRIDES1, PTR2, STRIDES2) \
