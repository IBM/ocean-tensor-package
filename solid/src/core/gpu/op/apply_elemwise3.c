...
/* ------------------------------------------------------------------------ */
int solid_gpu_elemwise3_analyze(int ndims, const size_t *size,
...
{  size_t       nelem;
   ...
   {  /* Determine the number of elements */
      ...
      flag_large = (solid_gpu_large_indexing(ndims, size, strides1, elemsize1) ||
                    ...
                    solid_gpu_large_indexing(ndims, size, strides3, elemsize3));
   }
