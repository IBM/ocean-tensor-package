...
#print("Importing pyOcean_gpu_v%d_%d" % (_sys_.version_info[0],_sys_.version_info[1]))
_module_name_ = "pyOcean_gpu_v%d_%d" % (_sys_.version_info[0],_sys_.version_info[1])
...
try :
   ...
   # or other problems.
   raise ValueError("Module pyOcean_gpu was not found")
